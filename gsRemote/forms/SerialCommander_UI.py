...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_5.addWidget(self.pushButton_tcclear, 2, 2, 1, 1)
        ...
        self.pushButton_tcsave = QtGui.QPushButton(self.tab_3)
        self.pushButton_tcsave.setObjectName(_fromUtf8("pushButton_tcsave"))
        self.horizontalLayout_2.addWidget(self.pushButton_tcsave)
